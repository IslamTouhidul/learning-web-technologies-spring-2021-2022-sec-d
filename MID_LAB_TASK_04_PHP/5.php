...
$counrty=[ "Italy"=>"Rome", "Luxembourg"=>"Luxembourg", "Belgium"=> "Brussels", "Denmark"=>"Copenhagen", "Finland"=>"Helsinki",
 ...
 "Lithuania"=>"Vilnius", "Czech Republic"=>"Prague","Estonia"=>"Tallin", "Hungary"=>"Budapest", "Latvia"=>"Riga", "Malta"=>"Valetta",
  ...
  foreach($counrty as $c => $capital){
        if($c==$n){
            echo "The capital of ".$n." is ".$capital;
        }
